...
export default function Announcements() {
  ...
  useEffect(() => {
    ...
    gsap.utils.toArray<SVGPathElement>(".float-element path").forEach(path => {
    ...
    const targetShape = "M100 0 L125 75 L200 100 L125 125 L100 200 L75 125 L0 100 L75 75 Z" // 4-point star

    if (headerIcon && headerIconPath) {
      const morphTimeline = gsap.timeline({ paused: true, defaults: { duration: 0.4, ease: "power2.inOut" } })
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none -z-10">
        {/* Red Element */}
        <svg className="float-element absolute top-[10%] left-[5%] w-24 h-24 sm:w-40 sm:h-40" viewBox="0 0 200 200" fill="none">
        ...
        {/* Yellow Element */}
        <svg className="float-element absolute top-[20%] right-[10%] w-20 h-20 sm:w-32 sm:h-32" viewBox="0 0 200 200" fill="none">
        ...
        {/* Green Element */}
        <svg className="float-element absolute bottom-[15%] left-[15%] w-28 h-28 sm:w-48 sm:h-48" viewBox="0 0 200 200" fill="none">
        ...
        {/* Violet Element */}
        <svg className="float-element absolute bottom-[5%] right-[5%] w-24 h-24 sm:w-40 sm:h-40" viewBox="0 0 200 200" fill="none">
