...
const NON_TECH_DEPARTMENTS: { [key: string]: DepartmentInfo } = { 
    ...
    "Outreach Team": { icon: Megaphone, description: "Act as the ambassadors of AIS. Engage with external organizations, build partnerships, and secure sponsorships.", skills: ["Public Speaking", "Networking", "Sponsorships", "PR"] }, 
    "Creative Team": { icon: Sparkles, description: "Define the visual identity of AIS. Design stunning graphics, posters, and UI/UX for all our events and projects.", skills: ["Canva/Figma", "Graphic Design", "UI/UX", "Branding"] }, 
    ...
    "Editorial Team": { icon: PenTool, description: "Craft the voice of AIS. Write compelling content for our blog, website, social media, and project documentation.", skills: ["Content Writing", "Technical Writing", "Blogging", "Social Media Copy"] } 
}
