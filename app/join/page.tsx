  ...
  useEffect(() => {
    ...
    for (let i = 0; i < particleCount; i++) {
      ...
      shuffledTargets.forEach((target) => {
        morphTl.to(path, { morphSVG: target }, "+=1");
      });
    }
...
interface TechDepartmentInfo extends DepartmentInfo {
  projects: string[];
  requirements: string[];
}
interface FAQItem {
...
const formSchema = z
  .object({
    ...
    year: z.enum(["1st", "2nd", "3rd", "4th", "Postgrad"], {
      required_error: "Please select your year",
    }),
    hostel: z.enum(["Yes", "No"], {
  ...
  .refine(
    (data) =>
      data.domain === "Tech"
        ? !!data.githubLink && data.githubLink.length > 0
        : true,
    {
...
const TECH_DEPARTMENTS: { [key: string]: TechDepartmentInfo } = {
  "Natural Language Processing (NLP)": {
    icon: MessageSquare,
    description:
      "Work with language models, text analysis, chatbots, and language understanding systems.",
    skills: [
      "Python",
      "Transformers",
      "NLTK",
  ...
  "Generative AI (GenAI)": {
    icon: Bot,
    description:
      "Create AI systems that generate content - text, images, code, and multimedia using cutting-edge generative models.",
    skills: [
      "Python",
      "PyTorch/TensorFlow",
      "Stable Diffusion",
  ...
  "Reinforcement Learning (RL)": {
    icon: Cpu,
    description:
      "Develop AI agents that learn through interaction with environments, perfect for game AI, robotics, and decision-making systems.",
    skills: [
      "Python",
      "OpenAI Gym",
      "Stable Baselines3",
  ...
  "Computer Vision (CV)": {
    icon: Eye,
    description:
      "Build AI systems that can see, understand, and interpret visual information from images and videos.",
    skills: [
      "Python",
      "OpenCV",
      "PyTorch/TensorFlow",
  ...
  Research: {
    icon: Star,
    description:
      "Dive deep into theoretical AI, explore novel concepts, and contribute to academic publications. This is for those who want to push the boundaries of AI knowledge.",
    skills: [
      "Python",
      "PyTorch/TensorFlow",
      "LaTeX",
    ...
    projects: [
      ...
      "Replication Studies of State-of-the-Art Models",
      "Literature Review Compilations",
    ],
    requirements: [
      "Strong academic and theoretical background",
      "Passion for exploring novel concepts",
...
const NON_TECH_DEPARTMENTS: { [key: string]: DepartmentInfo } = {
  "Management Team": {
    icon: Award,
    description:
      "Oversee the administrative and logistical backbone of the society. Coordinate meetings, manage events, and ensure smooth operations.",
    skills: [
      "Event Planning",
      "Project Management",
      "Leadership",
  ...
  "PR/Outreach Team": {
    icon: Megaphone,
    description:
      "Act as the ambassadors of AIS. Engage with external organizations, build partnerships, and secure sponsorships.",
    skills: ["Public Speaking", "Networking", "Sponsorships", "PR"],
  },
  "Creative Team": {
    icon: Sparkles,
    description:
      "Define the visual identity of AIS. Creative team consists of Design, Social Media, Editorial, and PR/Outreach. Design stunning graphics, posters, and UI/UX for all our events and projects.",
    skills: [
      "Canva/Figma",
      "Graphic Design",
      "UI/UX",
  ...
  "Multimedia Team": {
    icon: Zap,
    description:
      "Capture the essence of our events. Handle photography, videography, and create engaging video content and reels.",
    skills: ["Photography", "Video Editing", "Motion Graphics", "Storytelling"],
  },
  "Social Media": {
    icon: Globe,
    description:
      "Manage and grow AIS's online presence across all social media platforms. Create engaging content, schedule posts, interact with our community, and build our digital brand.",
    skills: [
...
const ALL_DEPARTMENTS_FOR_TABS = [
  ...Object.keys(TECH_DEPARTMENTS).map((dept) => ({
    name: dept,
    domain: "Tech" as const,
  })),
  ...Object.keys(NON_TECH_DEPARTMENTS).map((dept) => ({
    name: dept,
    domain: "Non-Tech" as const,
  })),
];
...
const TIMELINE_ITEMS = [
  {
    icon: Send,
    title: "Fill the Form",
    subtitle: "Applications open from 6th November to 16th November",
    description: "Applications: 128+",
    status: "ongoing",
    date: "6th Nov - 16th Nov",
  },
  {
    icon: Clock,
...
export default function JoinUs() {
  ...
  useEffect(() => {
    ...
    tl.fromTo(
      ...
      { y: 100, opacity: 0 },
      {
        y: 0,
        opacity: 1,
        duration: getOptimizedDuration(1, isMobile, reducedMotion),
        ease: getOptimizedEase(),
      }
    ).fromTo(
      ".form-section",
      { y: 50, opacity: 0 },
  ...
  const SuccessMessage = () => (
    <div className="text-center bg-white p-8 sm:p-12 rounded-2xl border border-green-300 shadow-lg">
      ...
      <p className="text-black/70 text-lg mb-8 max-w-lg mx-auto">
        Thank you for your interest. We have received your application and will
        review it shortly.
      </p>
      <MagneticButton
        onClick={() => {
  ...
  return (
    <div
      ref={pageRef}
      className="pt-32 pb-20 px-4 min-h-screen relative overflow-hidden bg-gray-50"
    >
            ...
            >
              ...
              >
                ...
                <p className="text-black/70 mb-2">
                  Please confirm that you want to apply for the:
                </p>
                ...
                <p className="text-sm text-black/60 mb-8">
                  Make sure all your details are correct before submitting. This
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <header className="page-header text-center mb-16">
          ...
          <p className="max-w-3xl mx-auto text-lg text-black/70 leading-relaxed font-semibold">
            Welcome to the AIS Core Selection Process! We are seeking dedicated
            individuals for{" "}
            <span className="text-black">
              Tech, Multimedia, Design and Management
            </span>{" "}
            roles.
          </p>
        </header>
        ...
        <section className="form-section bg-white p-8 rounded-2xl border border-black/10 hover:border-black/20 transition-all mb-12 group">
          ...
          <p className="text-black/70 leading-relaxed mb-4">
            The Artificial Intelligence Society (AIS) at Bennett University is
            one of the most research + open-source development focused student
            communities on campus. Our mission is to foster a deep understanding
            of AI and its applications by bringing together like-minded
            individuals who are eager to learn, share knowledge, and work on
            innovative projects.
          </p>
          <p className="text-black/70 leading-relaxed">
            <span className="font-semibold text-black">
              {" "}
              We are an exclusive group of productive individuals
            </span>
            , so keep that in mind while you fill the form honestly.
          </p>
        </section>
        ...
        <section className="form-section mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {Object.entries(TECH_DEPARTMENTS).map(([dept, info]) => (
              <div
                key={dept}
                className="bg-white p-8 rounded-2xl border border-black/10 hover:border-black hover:shadow-lg transition-all group"
              >
        ...
        <section className="form-section mb-12" data-dept-selector>
          <AnimatePresence mode="wait">
            {!selectedDepartment ? (
                ...
                <div className="relative w-full max-w-3xl bg-black rounded-2xl shadow-xl p-8 text-center overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-white/70 mt-2">
                      Select a department tab below or use the dropdowns in the
                      form.
                    </p>
                  </div>
                </div>
                <div className="w-full max-w-3xl bg-white/50 p-2 rounded-b-2xl shadow-xl -mt-1">
                  <div className="flex w-full" style={{ gap: `2px` }}>
                    {ALL_DEPARTMENTS_FOR_TABS.map((dept, index) => (
                      ...
                      >
                        <motion.button
                          className="relative bg-white border border-black/10 rounded-lg w-full h-full hover:bg-gray-100 transition-colors duration-200 group focus:outline-none focus:ring-0"
                          onMouseEnter={() => setHoveredDepartment(dept.name)}
                          onMouseLeave={() => setHoveredDepartment(null)}
                          onClick={() => handleSelectDepartment(dept)}
                          animate={{
                            y: hoveredDepartment === dept.name ? 20 : 0,
                            zIndex: hoveredDepartment === dept.name ? 10 : 1,
                          }}
                        ...
                        >
                          <div className="px-1 py-4 min-h-[100px] flex items-center justify-center">
                            <span
                              className="text-black/80 group-hover:text-black font-semibold text-[10px] sm:text-xs leading-tight text-center"
                              style={{
              ...
              <motion.div
                ...
                className="bg-white p-8 rounded-2xl border border-black/10 text-center"
              >
                ...
                <p className="text-black/60 mt-1">
                  Please complete the form below, or change your selection.
                </p>
                <button
                  onClick={resetDepartmentSelection}
                  className="mt-6 px-5 py-2.5 bg-black/5 text-black rounded-full font-medium hover:bg-black/10 transition-colors text-sm flex items-center justify-center mx-auto"
                >
            ...
            <form onSubmit={handleSubmit(onValidate)} className="space-y-6">
              ...
              <div key={domainValue || "department-wrapper"}>
                ...
                >
                  ...
                  {domainValue &&
                    ALL_DEPARTMENTS[
                      domainValue as keyof typeof ALL_DEPARTMENTS
                    ]?.map((dept) => (
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-semibold text-black mb-2">
                    Fictional Character you resemble yourself{" "}
                    <span className="text-red-500">*</span>
                  </label>
                  <input
                    type="text"
              ...
              <div className="pt-6">
                <MagneticButton
                  type="submit"
                  disabled={submissionStatus === "loading"}
                  className="w-full bg-black text-white py-4 rounded-full font-semibold text-lg hover:bg-black/90 transition-all flex items-center justify-center space-x-2 disabled:bg-gray-500 disabled:cursor-not-allowed group"
                >
                  <Send
                    size={20}
              ...
              <div className="space-y-6 text-black/70">
                ...
                <div>
                  ...
                  <p className="mb-2">
                    ...
                    obtain the certificates. These courses are covered in the
                    YouTube course by Abhishek Thakur's Kaggle Tutorial for
                    Beginners (World's first 4x Kaggle Grandmaster)
                  </p>
                ...
                <div>
                  <p>
                    Post Certificate on LinkedIn tagging{" "}
                    <a
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>
                      ...
                      GenAI / NLP department? Share a problem you want to solve
                      with AI in this domain and your approach.
                    </li>
                  </ul>
                </div>
                <div>
                  <p>
                    Bring your laptop to the interview. Ensure it's fully
                    charged and ready to showcase your work.
                  </p>
                </div>
              </div>
            </div>
          ...
          {activeGuideline === "community" && (
            <div className="bg-white p-8 rounded-2xl border border-black/10">
              ...
              <div className="space-y-6 text-black/70">
                <div>
                  <h4 className="font-bold text-black mb-2">
                    For Creative and Multimedia Teams:
                  </h4>
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      Submit your portfolio (designs, videos, writing samples)
                      in the form and be prepared to present them during the
                      interview.
                    </li>
                    <li>
                      Skills required may include: Figma, Canva, Adobe Suite,
                      Video Editing Software, strong writing abilities, etc.
                    </li>
                    <li>
                      Note: Creative Team consists of Design, Social Media,
                      Editorial, and PR/Outreach.
                    </li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-bold text-black mb-2">
                    For Management and PR/Outreach Teams:
                  </h4>
                  <ul className="list-disc list-inside space-y-1">
                    <li>
                      Your behavior, personality, and speaking skills will be
                      assessed through situational questions and potentially an
                      on-the-spot task during the interview.
                    </li>
                    <li>
                      Be prepared to discuss past experiences in leadership or
                      public relations.
                    </li>
                  </ul>
                </div>
                <p>
                  Bring your laptop to the interview to showcase any relevant
                  work.
                </p>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl border border-black/10">
              ...
              <div className="space-y-4 text-black/70">
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>
                    <strong>Bring your laptop</strong> and any necessary
                    accessories.
                  </li>
                  <li>
                    <strong>Be prepared to discuss</strong> your work, skills,
                    and experience in detail.
                  </li>
                  <li>
                    <strong>Showcase relevant projects.</strong> Highlight the
                    work that best represents your abilities.
                  </li>
                  <li>
          ...
          <div className="space-y-4">
            {FAQ_ITEMS.map((faq, index) => (
              ...
              >
                ...
                >
                  <h3 className="font-bold text-black flex-1 pr-4">
                    {faq.question}
                  </h3>
                ...
                {expandedFAQ === index && (
                  ...
                  >
                    <div className="px-6 pb-6 border-t border-gray-100">
                      <p className="text-black/70 leading-relaxed pt-4">
                        {faq.answer}
                      </p>
                    </div>
                  </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center group">
              ...
              <p className="text-white/80 text-sm">
                Access to cutting-edge AI resources and mentorship
              </p>
            </div>
            <div className="text-center group">
              <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
              ...
              <p className="text-white/80 text-sm">
                Connect with like-minded AI enthusiasts and industry experts
              </p>
            </div>
            <div className="text-center group">
              <div className="w-16 h-16 bg-white/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
              ...
              <p className="text-white/80 text-sm">
                Work on award-winning projects and research publications
              </p>
            </div>
          </div>
        </section>
