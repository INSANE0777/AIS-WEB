...
const HuggingFaceLogo = () => ( <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"> <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-2-13c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1s1-.45 1-1V8c0-.55-.45-1-1-1zm4 0c-.55 0-1 .45-1 1v4c0 .55.45 1 1 1s1-.45 1-1V8c0-.55-.45-1-1-1z"/> </svg> )
const TensorFlowLogo = () => ( <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"> <path d="M1.292 5.856L11.54 0v24l-4.095-2.378V7.603l-6.168 3.564.015-5.31zm21.416 5.311l-6.168-3.564v14.019L12.46 24V0l10.248 5.856v5.311z"/> </svg> )
const PyTorchLogo = () => ( <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"> <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm-1-17v6H5v2h6v6h2v-6h6v-2h-6V5h-2z"/> </svg> )
const KerasLogo = () => ( <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"> <path d="M12 2l3.09 6.26L22 9l-5.19 5.06L18.18 22 12 18.77 5.82 22l1.37-7.94L2 9l6.91-.74L12 2z"/> </svg> )
    ...
    >
      ...
      {!isMobile && (
        <div ref={techLogosRef} className="absolute inset-0 pointer-events-none">
          <TechLogo className="tech-logo-github absolute top-20 left-20 text-black/30 hover:text-black/80"><Github size={28} /></TechLogo>
          <TechLogo className="tech-logo-hf absolute top-32 right-32 text-black hover:text-black/80"><HuggingFaceLogo /></TechLogo>
          <TechLogo className="tech-logo-tf absolute bottom-40 left-32 text-black hover:text-black/80"><TensorFlowLogo /></TechLogo>
          <TechLogo className="tech-logo-pytorch absolute bottom-32 right-24 text-black hover:text-black/80"><PyTorchLogo /></TechLogo>
          <TechLogo className="tech-logo-keras absolute top-1/2 left-16 text-black hover:text-black/80"><KerasLogo /></TechLogo>
        </div>
      )}
